...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="Twitter",
                        help="Choose a dataset:[Twitter]")

    # model
    parser.add_argument("--model", type=str, default="LightGCN",
                        help="Choose a recommender:[GraphConv, LightGCN]")
    ...
    parser.add_argument('--test_batch_size', type=int,
                        default=64, help='batch size in evaluation phase')
    ...
    # parser.add_argument('--topks', default=[20])
    ...
    parser.add_argument("--save_path", type=str, default="/log.txt", \
                        help="save_path")
